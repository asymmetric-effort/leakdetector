...
export function Rules() {
  useHead({
    title: "Detection Rules — leakdetector",
    description:
      "How leakdetector detection rules work: regex matching, keyword pre-filtering, Shannon entropy, custom rules, and proximity rules.",
    canonical: "https://leakdetector.asymmetric-effort.com/#/rules",
    og: {
      title: "Detection Rules — leakdetector",
      description:
        "How leakdetector detection rules work: regex matching, keyword pre-filtering, Shannon entropy, custom rules, and proximity rules.",
      url: "https://leakdetector.asymmetric-effort.com/#/rules",
      type: "website",
    },
  });
  ...
  return (
    <div>
      ...
      <div class="section">
        ...
        <p>
          Rules may specify <code>keywords</code> — fast substring checks performed before
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>Very low randomness — likely a placeholder or constant</td>
            </tr>
            <tr>
              <td>1.5 – 3.0</td>
              <td><code>password123</code></td>
              <td>Low randomness — common patterns, dictionary words</td>
            </tr>
            <tr>
              <td>3.0 – 4.0</td>
              <td><code>myS3cr3tK3y!</code></td>
              <td>Moderate randomness — could be a weak secret</td>
            </tr>
            <tr>
              <td>4.0 – 5.0</td>
              <td><code>aK8x#mP2qL9w</code></td>
              <td>High randomness — likely a real secret</td>
            </tr>
            <tr>
              <td>5.0+</td>
              <td><code>f8a3b1c9e7d2a4f6</code></td>
              <td>Very high randomness — almost certainly a real secret or hash</td>
            </tr>
          </tbody>
        </table>
        <p>
