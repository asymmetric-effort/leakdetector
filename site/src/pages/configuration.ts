export function ConfigurationPage(): string {
  return `
<div class="section">
  <h2>Configuration</h2>
  <p>
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>string</td>
        <td>When to apply: <code>match</code> (suppress if regex matches the finding),
            <code>line</code> (suppress if regex matches the entire line)</td>
      </tr>
      <tr>
